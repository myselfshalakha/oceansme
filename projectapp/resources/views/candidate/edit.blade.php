...
?>
<div class="cstm_candidate_admin_edit cstm_common_admin">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-12">
					...
					<div class="tab-content" id="nav-tabContent">
					  <div class="tab-pane fade @if( $activeTab=='profile') show active @endif" id="nav-upd_profile" role="tabpanel" aria-labelledby="nav-home-tab">
							  <div class="card">
									...
									<div class="card-body">
										...
										<form method="POST" action="{{ route('admin.users') }}/candidate/update">
											@csrf
										...
										<div class="row mb-0 submit_btn_row">
											<div class="col-md-12 d-flex">
												...
												<a href="{{ route('admin.users') }}/candidate/" class="btn btn-secondary">
													Cancel
												</a>
											</div>  
										</div>
					  ...
					  <div class="tab-pane fade @if( $activeTab=='password') show active @endif" id="nav-upd_passwrd" role="tabpanel" aria-labelledby="nav-profile-tab">
									...
									<div class="card-body">
											<form method="POST" action="{{ route('admin.users') }}/candidate/changepassword">
											@csrf
														 <input type="hidden" name="id" value="{{ $user->id }}">
											<div class="row mb-3">
					  ...
					  <div class="tab-pane fade @if( $activeTab=='profileImage') show active @endif" id="nav-upd_prf_image" role="tabpanel" aria-labelledby="nav-contact-tab">
							  <div class="card">
									...
									<div class="card-body">
											<form method="POST" action="{{ route('admin.users') }}/candidate/changeprofileimage"  enctype="multipart/form-data">
											@csrf
														 <input type="hidden" name="id" value="{{ $user->id }}">
