 <?php
	 $event=$details["event"];
	 $user=$details["user"];
	 $acceptUrl=route('admin.events',['param'=>'attendResponse'])."?uev_id=".$event->uev_id."&status=4";
	 $declineUrl=route('admin.events',['param'=>'attendResponse'])."?uev_id=".$event->uev_id."&status=2";
