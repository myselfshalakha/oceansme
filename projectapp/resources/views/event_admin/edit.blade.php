...
?>
<div class="cstm_common_admin cstm_event_admin_edit">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-12">
					...
					<div class="tab-content" id="nav-tabContent">
					  <div class="tab-pane fade @if( $activeTab=='profile') show active @endif" id="nav-upd_profile" role="tabpanel" aria-labelledby="nav-home-tab">
							  <div class="card">
									...
									<div class="card-body">
										...
										<form method="POST" action="{{ route('admin.users') }}/event_admin/update">
											@csrf
					  ...
					  <div class="tab-pane fade @if( $activeTab=='password') show active @endif" id="nav-upd_passwrd" role="tabpanel" aria-labelledby="nav-profile-tab">
									...
									<div class="card-body">
											<form method="POST" action="{{ route('admin.users') }}/event_admin/changepassword">
											@csrf
														 <input type="hidden" name="id" value="{{ $user->id }}">
											<div class="row mb-3">
					  ...
					  <div class="tab-pane fade @if( $activeTab=='profileImage') show active @endif" id="nav-upd_prf_image" role="tabpanel" aria-labelledby="nav-contact-tab">
							  <div class="card">
									...
									<div class="card-body">
											<form method="POST" action="{{ route('admin.users') }}/event_admin/changeprofileimage"  enctype="multipart/form-data">
											@csrf
														 <input type="hidden" name="id" value="{{ $user->id }}">
